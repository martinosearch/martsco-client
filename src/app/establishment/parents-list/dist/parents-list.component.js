...
exports.ParentsListComponent = void 0;
...
var student_parent_identity_bean_1 = require("../models/student-parent-identity-bean");
var ParentsListComponent = /** @class */ (function () {
    function ParentsListComponent(auth, dialog, dataService) {
        this.auth = auth;
        this.dialog = dialog;
    ...
    ParentsListComponent.prototype.ngOnInit = function () {
        this.refresh();
    };
    ParentsListComponent.prototype.ngOnDestroy = function () { };
    ParentsListComponent.prototype.refresh = function () {
        var _this = this;
    ...
    ParentsListComponent.prototype.onDelete = function (obj) {
        var _this = this;
    ...
    ParentsListComponent.prototype.sleep = function (ms) {
        return new Promise(function (resolve) { return setTimeout(resolve, ms); });
    };
    ParentsListComponent.prototype.onCreate = function () {
        var _this = this;
        var dialogRef = this.dialog.open(employee_form_component_1.EmployeeFormComponent, {
            width: '1000px',
            data: { titre: 'Ajouter un parent', obj: new student_parent_identity_bean_1.StudentParentIdentityBean() }
        });
    ...
    ParentsListComponent.prototype.onModify = function (currentObj) {
        var _this = this;
    ...
    ParentsListComponent.prototype.filter = function () {
    ...
    ParentsListComponent = __decorate([
        core_1.Component({
