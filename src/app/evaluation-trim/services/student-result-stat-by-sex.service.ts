...
export class StudentResultStatBySexService {
  ...
  generateStatStandardPdf(evaluation: boolean, statMixte: boolean): Observable<any> {
      ...
      this.progressService.getNewProgressId().subscribe((progressId) => {
        ...
        dialogRef.componentInstance.eventEmitter.subscribe(
          (chooserModel: ClassChooserModel) => {
            ...
            this.fileService.downloadAndShowPdf(url, "stat_par_genre_niveau", progressId);
      ...
      this.progressService.getNewProgressId().subscribe((progressId) => {
        ...
        dialogRef.componentInstance.eventEmitter.subscribe(
          (chooserModel: ClassChooserModel) => {
            ...
            this.fileService.downloadAndShowPdf(url, "stat_par_genre_classe", progressId);
            observer.next();
          });
      });
    });
