...
exports.ExamEstablishmentListComponent = void 0;
...
var ExamEstablishmentListComponent = /** @class */ (function () {
    function ExamEstablishmentListComponent(auth, messageService, dialog, establishmentExamService) {
        this.auth = auth;
    ...
    ExamEstablishmentListComponent.prototype.ngOnInit = function () {
        this.refresh();
    };
    ExamEstablishmentListComponent.prototype.ngOnDestroy = function () { };
    ExamEstablishmentListComponent.prototype.refresh = function () {
        var _this = this;
    ...
    ExamEstablishmentListComponent.prototype.onDelete = function (obj) {
        var _this = this;
        ...
        dialogRef.componentInstance.event.subscribe(function (response) {
            _this.establishmentExamService["delete"](obj.id).subscribe(function (resp) {
    ...
    ExamEstablishmentListComponent.prototype.onCreate = function () {
        var _this = this;
        var dialogRef = this.dialog.open(exam_establishment_form_component_1.ExamEstablishmentFormComponent, {
            width: '600px',
            data: { titre: 'Ajouter un établissement', obj: new exam_establishment_identity_bean_1.EstablishmentExamIdentityBean() }
        });
        dialogRef.componentInstance.event.subscribe(function (response) {
            _this.refresh();
        });
    };
    ExamEstablishmentListComponent.prototype.onModify = function (currentObj) {
        var _this = this;
    ...
    ExamEstablishmentListComponent.prototype.onSetting = function (currentObj) {
        var _this = this;
        var data = Object.assign({}, currentObj);
        var dialogRef = this.dialog.open(exam_establishment_form_component_1.ExamEstablishmentFormComponent, {
            width: '1000px',
    ...
    ExamEstablishmentListComponent.prototype.filter = function () {
    ...
    ExamEstablishmentListComponent = __decorate([
        core_1.Component({
    ...
    ], ExamEstablishmentListComponent);
    return ExamEstablishmentListComponent;
}());
exports.ExamEstablishmentListComponent = ExamEstablishmentListComponent;
